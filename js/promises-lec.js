...
// var pokemonAPI = fetch('https://pokeapi.co/api/v2/pokemon').then((response)=>{return response.json()}).then((jsonData)=>{return jsonData.results}).then ((results)=>results.forEach(result=>console.log(result.name)));
