...
var hatSearchId = document.getElementById('hat-search');

console.log(hatSearchId)
...
var dFlexSearchClass = document.getElementsByClassName('d-flex')

console.log(dFlexSearchClass);
...
for(var i = 0; i < dFlexSearchClass.length; i++){
    console.log(dFlexSearchClass[i]);
}
