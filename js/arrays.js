...
// TODO: What happens if we change var i = 1? or var i = 2; ** square would never be iterated then rectangle respectively
// TODO: What are benefits of using loops to iterate? ** makes for easier to
// TODO: How does the loop know when to stop iterating? ** once the loop reaches the full length of the array
...
for (var i = 0 ; i < instructors.length ; i++){
    if (instructors[i] === "kenneth" || instructors[i] === "douglas" || instructors[i] === "samuel"){
        alert("Hey! I know " + instructors[i] + "!!!")
    }else{
        console.log("I haven't had class with " + instructors[i] + ".")
    }
}
